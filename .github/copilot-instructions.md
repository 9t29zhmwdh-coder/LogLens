# Copilot Instructions for LogLens
LogLens is a cross-platform desktop app that collects, normalizes, clusters, and explains logs from files, Docker containers, and system logs. It combines full-text search with AI-generated explanations (Claude by default, or a local Ollama model) to reduce triage time from hours to minutes.
## Code style
