...
const translations: Record<Lang, Dict> = {
  en: {
    ...
    sources: {
      ...
      addSyslogTitle: 'Add syslog listener',
      syslogHint: 'Point your firewall, gateway or access point at this address. UniFi, pfSense, OPNsense and RouterOS are recognized automatically.',
      syslogProtocol: 'Protocol',
      syslogListen: 'Listen',
      syslogSourceAdded: 'Syslog listener started',
  ...
  de: {
    ...
    sources: {
      ...
      addSyslogTitle: 'Syslog-Empfänger hinzufügen',
      syslogHint: 'Richte Firewall, Gateway oder Access Point auf diese Adresse. UniFi, pfSense, OPNsense und RouterOS werden automatisch erkannt.',
      syslogProtocol: 'Protokoll',
      syslogListen: 'Empfangen',
      syslogSourceAdded: 'Syslog-Empfänger gestartet',
